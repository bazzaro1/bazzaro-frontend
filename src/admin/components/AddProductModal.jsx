  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
      ...
      >
        ...
        <input name="price" placeholder="Narxi" required
          value={form.price} onChange={handleChange}
          className="w-full p-2 border rounded" />

        <select name="parentCategory" required
          value={form.parentCategory} onChange={handleChange}
          className="w-full p-2 border rounded"
        >
        ...
        <div className="flex justify-end space-x-2">
          <button type="button" onClick={onClose} className="bg-gray-300 px-4 py-2 rounded">Bekor</button>
